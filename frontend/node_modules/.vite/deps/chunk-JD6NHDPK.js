...
var Portal = React17.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(React17.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React17.isValidElement(children)) {
      ...
      return React17.cloneElement(children, newProps);
    }
    return children;
  }
...
var Fade = React18.forwardRef(function Fade2(props, ref) {
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime15.jsx)(TransitionComponent, {
    appear,
    in: inProp,
...
var Backdrop = React19.forwardRef(function Backdrop2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiBackdrop"
  });
  ...
  return (0, import_jsx_runtime16.jsx)(TransitionSlot, {
    in: open,
    timeout: transitionDuration,
    ...other,
    ...transitionProps,
    children: (0, import_jsx_runtime16.jsx)(RootSlot, {
      "aria-hidden": true,
      ...rootProps,
      classes,
      ref,
...
//# sourceMappingURL=chunk-JD6NHDPK.js.map
